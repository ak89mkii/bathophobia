...
public class ObstacleSpawnerDeep : MonoBehaviour
{
    ...
    public float startSpawningAtDistance = 500f;  // Distance at which to start spawning
    ...
    void Update()
    {
        ...
        // Start spawning enemies after the player reaches the startSpawningAtDistance
        if (distanceInMeters < startSpawningAtDistance)
        {
            return;
        }
    ...
    void SpawnEnemy()
    {
        ...
        enemy.AddComponent<DestroyWhenOutOfView2>();
    }
}

// This script should be attached to the enemy object.
public class DestroyWhenOutOfView2 : MonoBehaviour
{
